...
namespace PointShop.Helpers
{
    public static class UIElementHelper
    {
        ...
        public static Vector2 Size(this UIElement uie) => new(uie.Width.Pixels, uie.Height.Pixels);
        public static Vector2 Pos(this UIElement uie) => new(uie.Left.Pixels, uie.Top.Pixels);
