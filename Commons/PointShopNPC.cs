...
public class PointShopNPC : GlobalNPC
{
    ...
    // 原来的限制，必须攻击过这个 NPC 的玩家才能获取积分
    // 现在修改为掉落物品，无条件掉落积分币，但是你得能捡到
    ...
    //         {
    //             var stars = BestiaryHelper.GetBestiaryStarsPriority(npc);
    //             EnvironmentManager.Instance.SetPoints(stars);
    //             var combatIndex =
    //                 CombatText.NewText(npc.getRect(), Color.Red, $"积分 +{stars}", dramatic: false, dot: true);
    //             var combat = Main.combatText[combatIndex];
    //             combat.scale = 1;
    //
    ...
    //             //     var pos = Main.LocalPlayer.position;
    //             //     pos.X += Main.LocalPlayer.Size.X / 2f;
    //             //     PointShopHelper.PointTip(terrainName, point, pos, color, 90);
    //             // }
    //
    //             break;
    //         }
